...
export async function writeAudit(payload: AuditPayload) {
  ...
  const res = await AppDataSource.query(
    ...
    [payload.actor_id || null, payload.actor_type || null, payload.action, payload.resource, payload.resource_id || null, payload.data ? JSON.stringify(payload.data) : null, payload.outcome || null]
  );
