...
1. Create or update a GitHub Issue (requirements/design change).
...
**GitHub Issue:** [#59](https://github.com/Vanopticon/Odin/issues/59)
...
**GitHub Issue:** [#CGM](link-to-issue)
